<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="arac.aspx.cs" Inherits="AracKiralamaOtomasyonu.arac" %>
	...
	<body>
		<form id="form1" runat="server">
			...
			<div class="wrapper" style="min-width:700px;">
				<table style="min-width: 630px;">
					<tr><td>
						<div class="p-3 mt-3">
							<div>
								<asp:ImageButton class="form-field d-flex align-items-center fixed-height" ID="ibAracResim" runat="server" style="width:250px;height:190px;padding-left:0px;"  ImageUrl="~/assets/ortak/pictures/car_logo_blank.png"/>
							</div>
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:DropDownList ID="dplKayitlar" runat="server" DataSourceID="SqlDataSource1" DataTextField="aracPlaka" DataValueField="aracPlaka" AutoPostBack="True" OnSelectedIndexChanged="dplKayitlar_SelectedIndexChanged"></asp:DropDownList>
							...
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtAracMarka" runat="server" placeholder="Arac Markası" ReadOnly="True"></asp:TextBox>
								</div>
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtAracAdi" runat="server" placeholder="Arac Adı" ReadOnly="True"></asp:TextBox>
							</div>
						</div>
					</td><td>
						<div class="p-3 mt-3">
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtRenk" runat="server" placeholder="Renk" ReadOnly="True"></asp:TextBox>
							</div>
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtYakit" runat="server" placeholder="Yakıt Türü" ReadOnly="True"></asp:TextBox>
							</div>
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtVites" runat="server" placeholder="Vites Tipi" ReadOnly="True"></asp:TextBox>
							</div>
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtBavulAded" runat="server" placeholder="Bavul Sayısı" ReadOnly="True"></asp:TextBox>
							</div>
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtKoltukAded" runat="server" placeholder="Koltuk Sayısı" ReadOnly="True"></asp:TextBox>
							</div>
							<div class="form-field d-flex align-items-center fixed-height">
								<asp:TextBox ID="txtKlima" runat="server" placeholder="Klima Durumu" ReadOnly="True"></asp:TextBox>
							</div>
						</div>
					</td></tr>
				</table>
				<asp:Button ID="btnKirala" runat="server" Text="Kirala" class="btn mt-3" OnClick="btnKirala_Click"/>
				<asp:Button ID="btnTeslimEt" Visible="false" runat="server" Text="Teslim Et" class="btn mt-3"/> 
			</div>
			...
			<script>
				...
				$("#uplAracResim").change(function () { readURL(this); });
			</script>
		</form>
	</body>
</html>
