<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="araclar.aspx.cs" Inherits="AracKiralamaOtomasyonu.araclar" %>
...
<body>
    <form id="form1" runat="server">
				...
				<div class="site-header__middle">
					<nav class="nav">
						...
						<ul class="nav__wrapper">
							...
							<li class="nav__item">
								<asp:LinkButton ID="lbAraclarNav" runat="server" class="header_link">Kiralanabilen Araçlar</asp:LinkButton> 
							</li>
							<li class="nav__item">
		...
		<div class="wrapper content_container" >
			...
			<div id="slider1" runat="server" style="padding-left: 10px;overflow-x: auto;overflow-y: hidden;">
			</div>
			<br />
		</div>
    </form>
